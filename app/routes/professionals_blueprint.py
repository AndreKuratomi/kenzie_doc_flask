...
from app.controllers.professionals_controller import create_professional, update_professional, delete_professional,get_all_professionals, filter_by_speciality
...
bp_professionals.get('/filter')(filter_by_speciality)
